...
description: |
  This is a time series analysis of the number  of employed GVSU graduates from 2016 to 2021.
author:
...
data_for_ts<-data %>%
 ...
 ggplot( data = data_for_ts, aes( Year_Recorded, Employed_Percentage )) + 
   geom_line()+
   xlab("<b> Employed Percentage </b>") + ylab("<b> Year Recorded </b>")
```
It was observed that there was a higher number of employed graduates than those who were seeking employment throughout the period of 2016 to 2021. For instance in 2020, employed students were 1232 while those seeking employment were 287. 
...
```
There was a decline in the number of students employed from 2019 to 2020 (1327 to 1232) but there was almost an equal increase in the number of graduates who enrolled for masters degree in the same year (263 to 340). However, 2021 is already showing a rise in the number of students getting jobs.
